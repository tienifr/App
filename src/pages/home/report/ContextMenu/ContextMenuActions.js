...
export default [
    ...
    },
    {
        ...
        successIcon: null,
        shouldShow: (type, reportAction, isArchivedRoom, betas) =>
            Permissions.canUseThreads(betas) &&
            type === CONTEXT_MENU_TYPES.REPORT_ACTION &&
            reportAction.actionName === CONST.REPORT.ACTIONS.TYPE.ADDCOMMENT &&
            !ReportUtils.isThreadFirstChat(reportAction),
    ...
    },
    {
        ...
        onPress: (closePopover, {reportID, parentReportId,reportAction}) => {
            if (closePopover) {
                // Hide popover, then call showDeleteConfirmModal
                hideContextMenu(false, () => showDeleteModal(reportID, reportAction,parentReportId));
                return;
            }

            // No popover to hide, call showDeleteConfirmModal immediately
            showDeleteModal(reportID, reportAction,parentReportId);
        },
        getDescription: () => {},
    },
];
