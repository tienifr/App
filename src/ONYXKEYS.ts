...
const ONYXKEYS = {
    ...
    COLLECTION: {
        ...
        REPORT_IS_COMPOSER_EDIT_FULL_SIZE: 'reportIsComposerEditFullSize_',
...
type OnyxCollectionValuesMapping = {
    ...
    [ONYXKEYS.COLLECTION.REPORT_IS_COMPOSER_EDIT_FULL_SIZE]: OnyxTypes.ReportIsComposerEditFullSize;
